...
" License:      MIT (2021)
" Last Updated: Sat 27 May 18:42:33 2023
...
hi ModeMsg guifg=#94baca guibg=bg gui=NONE cterm=NONE
hi! link MoreMsg ModeMsg
hi! link Question ModeMsg
hi! link Ignore NonText
hi Todo guifg=#679d80 guibg=bg gui=bold cterm=bold
hi Underlined guifg=#c9c9c9 guibg=bg gui=underline cterm=underline
...
hi Title guifg=#a79180 guibg=bg gui=bold cterm=bold
hi LineNr guifg=#666967 guibg=bg gui=NONE cterm=NONE
...
hi CursorLine guifg=#2a2a2a guibg=bg gui=NONE cterm=NONE
hi! link CursorColumn CursorLine
hi ColorColumn guifg=fg guibg=#1a1a1a gui=NONE cterm=NONE
hi SignColumn guifg=#666967 guibg=bg gui=NONE cterm=NONE
hi Visual guifg=fg guibg=#343434 gui=NONE cterm=NONE
hi VisualNOS guifg=fg guibg=#343434 gui=NONE cterm=NONE
hi Pmenu guifg=fg guibg=#2a2a2a gui=NONE cterm=NONE
hi PmenuSbar guifg=fg guibg=#343434 gui=NONE cterm=NONE
hi PmenuSel guifg=#a79180 guibg=#343434 gui=NONE cterm=NONE
hi PmenuThumb guifg=#94baca guibg=#94baca gui=NONE cterm=NONE
hi FoldColumn guifg=#2a2a2a guibg=bg gui=NONE cterm=NONE
hi Folded guifg=#666967 guibg=#1a1a1a gui=NONE cterm=NONE
hi SpecialKey guifg=#a79180 guibg=bg gui=NONE cterm=NONE
hi IncSearch guifg=#222222 guibg=#eab56b gui=NONE cterm=NONE
hi Search guifg=#222222 guibg=#a79180 gui=NONE cterm=NONE
hi! link CurSearch IncSearch
hi Directory guifg=#94baca guibg=bg gui=NONE cterm=NONE
hi MatchParen guifg=#eab56b guibg=bg gui=bold cterm=bold
hi SpellBad guifg=#a74f4f guibg=bg gui=underline cterm=underline
hi SpellCap guifg=#679d80 guibg=bg gui=underline cterm=underline
hi SpellLocal guifg=#eab56b guibg=bg gui=underline cterm=underline
hi! link SpellRare SpellLocal
hi QuickFixLine guifg=fg guibg=#1a1a1a gui=NONE cterm=NONE
...
hi helpHyperTextJump guifg=#94baca guibg=#222222 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi! link Warning WarningMsg
  hi ModeMsg ctermfg=109 ctermbg=bg cterm=NONE
  hi! link MoreMsg ModeMsg
  hi! link Question ModeMsg
  hi! link Ignore NonText
  hi Todo ctermfg=72 ctermbg=bg cterm=bold
  hi Underlined ctermfg=251 ctermbg=bg cterm=underline
  ...
  hi Title ctermfg=137 ctermbg=bg cterm=bold
  hi LineNr ctermfg=242 ctermbg=bg cterm=NONE
  hi! link LineNrAbove LineNr
  hi! link LineNrBelow LineNr
  hi CursorLineNr ctermfg=179 ctermbg=235 cterm=NONE
  hi Cursor ctermfg=235 ctermbg=251 cterm=NONE
  hi CursorLine ctermfg=235 ctermbg=bg cterm=NONE
  hi! link CursorColumn CursorLine
  hi ColorColumn ctermfg=fg ctermbg=234 cterm=NONE
  hi SignColumn ctermfg=242 ctermbg=bg cterm=NONE
  hi Visual ctermfg=fg ctermbg=236 cterm=NONE
  hi VisualNOS ctermfg=fg ctermbg=236 cterm=NONE
  hi Pmenu ctermfg=fg ctermbg=235 cterm=NONE
  hi PmenuSbar ctermfg=fg ctermbg=236 cterm=NONE
  hi PmenuSel ctermfg=137 ctermbg=236 cterm=NONE
  hi PmenuThumb ctermfg=109 ctermbg=109 cterm=NONE
  hi FoldColumn ctermfg=235 ctermbg=bg cterm=NONE
  hi Folded ctermfg=242 ctermbg=234 cterm=NONE
  hi SpecialKey ctermfg=137 ctermbg=bg cterm=NONE
  hi IncSearch ctermfg=235 ctermbg=179 cterm=NONE
  hi Search ctermfg=235 ctermbg=137 cterm=NONE
  hi! link CurSearch IncSearch
  hi Directory ctermfg=109 ctermbg=bg cterm=NONE
  hi MatchParen ctermfg=179 ctermbg=bg cterm=bold
  hi SpellBad ctermfg=131 ctermbg=bg cterm=underline
  hi SpellCap ctermfg=72 ctermbg=bg cterm=underline
  hi SpellLocal ctermfg=179 ctermbg=bg cterm=underline
  hi! link SpellRare SpellLocal
  hi QuickFixLine ctermfg=fg ctermbg=234 cterm=NONE
  ...
  hi! link diffAdded DiffAdd
  hi! link diffRemoved DiffDelete
  hi helpHyperTextJump ctermfg=109 ctermbg=235 cterm=NONE
  hi! link htmlTag Delimiter
  hi! link htmlEndTag htmlTag
  hi! link gitcommitSummary Title
  unlet s:t_Co
...
" Term Colors: black     red      green      wood    term_b_blue term_b_magenta term_b_cyan white_alt
" Term Colors: black_alt term_red term_green yellow  teal        term_magenta   term_cyan   white
" vim: et ts=2 sw=2
